...
export default {
  mounted() {
    this.$store.commit("app/SET_TITLE", "Contact Details");
    if (
      this.user.registered_stages &&
      !(
        this.user.registered_stages.includes("contact-details") ||
        this.user.next_stage === "contact-details"
      )
    ) {
